 ...
 * 
 */
package com.udemyspring.SpringbootprojectUdemy.a2;
 ...
 * 
 * @Component class Youbusinessclass {
 * 
 ...
 * 
 * @Autowired public Youbusinessclass(Dependency1 dependency1, Dependency2
 * dependency2) { super(); this.dependency1 = dependency1; this.dependency2 =
 * dependency2; }
 * 
 ...
 * 
 * public String toString() { return "Using" + dependency1 + "and" +
 * dependency2; } }
 * 
...
class XMLLauncherApplication {
	...
	public static void main(String[] args) {
		try (var context = new ClassPathXmlApplicationContext("contectconfig.xml")) {
			Arrays.stream(context.getBeanDefinitionNames()).forEach(System.out::println);
			System.out.println(context.getBean(XMLLauncherApplication.class));
